/**
 * Accessibility helper panel — routes, companion assist, and sensory-friendly info.
 */
    ...
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '32px 24px 80px' }}>
          ...
          {routes.map(r => (
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '4px', flexShrink: 0 }}>
                <span className={r.clear ? 'badge badge-green' : 'badge badge-red'}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
          ...
          <button className="btn-glass" style={{ borderColor: 'rgba(255,71,87,0.3)', color: 'var(--red)' }}>
            📞 Call Now
          </button>
        </div>
      </div>
